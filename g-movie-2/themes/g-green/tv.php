...
<html lang="en-US" prefix="og: http://ogp.me/ns#">
   ...
   <body class="dark movie single" style="background-image:url(https://image.tmdb.org/t/p/original<?php echo $row[backdrop_path];?>)">
      <header>
               ...
               <div class="row">
                  <article id="post-400710" class="post col-md-8">
                     <ol class="breadcrumb" itemscope itemtype="https://schema.org/BreadcrumbList">
                        <li class="home" itemprop="itemListElement" itemscope itemtype="https://schema.org/TVShow">
                           <span itemprop="name">
                        ...
                        <li itemprop="itemListElement" itemscope itemtype="https://schema.org/TVShow">
                           <span itemprop="name">
                     ...
                     <div class="entry-content">
                        <div class="row">
                           <div class="col-md-3 text-center">
                              ...
                              <div class="rating-star" title="<?php echo $get_rating;?> out of 10 stars" itemprop="aggregateRating" itemscope itemtype="https://schema.org/AggregateRating">
                                 <?php for($k=1;$k<=$get_rating;$k++){?><i class="fa fa-star"></i><?php }?><?php for($i=$emp_rating;$i>=1;$i--){?><i class="fa fa-star-o"></i><?php $k++; } ?>
