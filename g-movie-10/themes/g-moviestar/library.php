...
<div class="container">
<div class="pad"></div><ol class="breadcrumb hidden-xs"><li itemscope="" itemtype="https://data-vocabulary.org/Breadcrumb"><a itemprop="url" href="<?php echo site_url() ?>/"><span itemprop="title"><i class="fa fa-home"></i> Home</span></a></li><li itemscope="" itemtype="https://data-vocabulary.org/Breadcrumb"><span itemprop="title"><a href="<?php echo site_url() ?>/library" title="Library" itemprop="url">Library</a> </span></li><li class="active"><span>0-9</span></li></ol>
