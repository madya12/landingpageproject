...
<div style="background: black; width: 100%; padding: 7px; overflow: hidden; position: relative; z-index: 999; display: table;">
	<div class="container">
		<span class="pull-right" style="color: #cacaca; font-size: 14px;">TRY PREMIUM FOR FREE &nbsp; &nbsp; : 
			<a href="javascript:void(0)" data-toggle="modal" data-target="#reg_form" style="color: #E69090!important; font-size: 14px;">&nbsp; &nbsp; LOGIN / REGISTER</a>
		</span>
	</div>
</div>
	...
	<div class="container">
		...
		<div class="navbar-collapse collapse">
			...
			<ul id="menu-danger" class="nav navbar-nav" style="margin-top: -24.5px;">
				...
				<li class="dropdown ">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">MOVIES</a>
				...
				<li class="dropdown ">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">TV SERIES</a>
					<ul class="dropdown-menu">
						<li><a href="<?php echo view_page( 'tv-airing' );?>"><i class="fa fa-random"></i> Airing TV</a></li>
                        <li><a href="<?php echo view_page( 'tv-ontheair' );?>"><i class="fa fa-line-chart"></i> On the Air TV</a></li>
                        <li><a href="<?php echo view_page( 'tv-popular' );?>"><i class="fa fa-star"></i> Popular TV</a></li>
					</ul>
				</li>
				<li class="dropdown">
				...
				<li><a href="<?php echo site_url() ?>/?s=">Search</a></li>
			</ul>
		</div>
	</div>
</div>