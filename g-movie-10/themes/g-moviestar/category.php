...
<div class="row">
   <div class="col-sm-12">
      <h2>Category for "<?php echo $dirname;?>"<?php echo $hal;?></h2>
                ...
                ?>
                  <div class="col-md-15 col-xs-6 margin-bottom-20 movie-slide slick-slide" style="width: 250px;">
                     <div class="movie-poster">
                        <aside>
                           <div>
						   <a href="<?php echo seo_movie($row['id'],$row['title']);?>" class="read-more"><?php echo $row['title'];?></a>
							  ...
							  <span class="date"><?php echo $row['vote_count'];?> Likes</span>
                           </div>
                        </aside>
