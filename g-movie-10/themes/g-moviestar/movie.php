...
filter: blur(5px);">
	...
	<a href="https://youtu.be/AntcyqJ6brc" data-vbtype="video" class="venobox video vbox-item">
...
<script>
            ...
            var pausetime = 20; // stop at 15 seconds 
            ...
            myPlayer.disableProgress({
				...
				<center><a href="/?action=register" class=" btn btn-default vbox-item btn-download"><i class="fa fa-play"></i>
					<span>Play Now</span></a> &nbsp;<a href="/?action=register" class=" btn btn-default vbox-item btn-download"><i class="fa fa-download"></i>
					<span>Download</span></a></center>
				</div>
				...
				<div class="col-md-9">
					...
					<table style="width:100%">
						<tbody>
						<tr>
														<td width="170px">Release Date</td>
														<td>: &nbsp;</td>
							<td><?php echo $release_date;?></td>
						</tr>
												<tr>
							<td width="170px">Runtime</td>
							<td>: &nbsp;</td>
							<td><time itemprop="duration" datetime="PT<?php echo $runtime;?>M"><?php echo $runtime;?> minutes</time></td> 
						</tr>
																		<tr>
							<td width="170px">Rating</td>
							<td>: &nbsp;</td>
							<td><span itemprop="ratingValue"><?php echo $get_rating;?></span>/<span itemprop="bestRating">10</span> by <span itemprop="ratingCount"><?php echo $vote_count;?></span> users</td> 
						</tr>
						<tr>
						...
						<tr>
							<td width="170px">Popularity</td>
							<td>: &nbsp;</td>
							<td><?php echo $row['popularity'];?></td> 
						</tr>
						<tr>
							<td width="170px">Production Company</td>
							<td>: &nbsp;</td>
							<td><?php echo $companies;?></td>
						</tr>
						<tr>
							<td width="170px">Production Countries</td>
							<td>: &nbsp;</td>
   ...
   <div class="col-sm-12">
      ...
      <div class="slick-carousel slick-initialized slick-slider" id="newIn">
         <?php
                            ...
                            ?>
                  <div class="movie-slide slick-slide" style="width: 150px;">
                     <div class="movie-poster">
                        <aside>
                           <div>
                              <a href="<?php echo seo_movie($similar['id'],$similar['title']);?>" data-vbtype="video" class="play">
                              <i class="material-icons">play_arrow</i>
                              </a>
                              <a href="<?php echo seo_movie($similar['id'],$similar['title']);?>" class="read-more">Watch Now</a>
                              <span class="date">Released: <?php echo date('Y-m-d', strtotime( $similar['release_date'] ) );?></span>
                           </div>
                        </aside>
                        <a href="<?php echo seo_movie($similar['id'],$similar['title']);?>">
                        <img src="https://image.tmdb.org/t/p/original/<?php echo $similar['poster_path'];?>" alt="<?php echo $similar['title'];?>">
                     </div>
