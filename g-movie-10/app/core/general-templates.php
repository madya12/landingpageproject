...
function get_menu( ) {
        if (file_exists( $_SERVER['DOCUMENT_ROOT'] . '/themes/'. config('sitethemes') . '/menu.php' ))
                include ( $_SERVER['DOCUMENT_ROOT'] . '/themes/' . config('sitethemes') . '/menu.php' );
}
function get_slide( ) {
        if (file_exists( $_SERVER['DOCUMENT_ROOT'] . '/themes/'. config('sitethemes') . '/slide.php' ))
                include ( $_SERVER['DOCUMENT_ROOT'] . '/themes/' . config('sitethemes') . '/slide.php' );
}
function _seo( $query ) {
        if ( config('_seo') == 'true' ):
