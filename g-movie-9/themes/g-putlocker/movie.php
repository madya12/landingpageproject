...
<script>
	...
	<div class="row justify-content-center border-bottom " align="center" style="border-bottom:1px solid #061b2c !Important; padding-top:5px; font-size: 2rem">
	    	    Watch <?php echo $title;?> Full Movie
	</div>
	<div class="row justify-content-center border-bottom " align="center" style="border-bottom:1px solid #061b2c !Important">
	<a href="/register" target="_blank" style="border:none;"><img src="//cdn.kfiopkln.com/images/slider_ads/468_60/468__60_Blue_2Btn_dld_wn_EN.png" style="border:none;"></a>
	</div>
         ...
         <div class="" style="padding-top:20px;">
            <form method="post" enctype="multipart/form-data">
               ...
               <div class="fs16">
                  ...
                  <br />
                  <div class="pt-10">
                     <a class="btn btn-outline-primary btn-sm radius-lg color-white" data-toggle="modal" data-target="#trailer" style="margin-top: 10px; width : 40%;	"  > Trailer </a> 
        ...
        ?>
		 ...
		 <?php
            ...
            <div class="item item-page" style="z-index:999999;" align="center">
               ...
               <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12 p0 ">
                     <img src="<?php echo $backdrop_path;?>" class="responsive" /> 
                     <div class="page-detail p10 fs12" align="left">
                        <a class="fs12" > Title :  <?php echo $similar['title'];?></a> <br>
                        Rating : <?php echo $row['vote_average'];?> <br>
                        Release : <?php echo date('Y-m-d', strtotime( $row['release_date'] ) );?>
                        <a href="<?php echo seo_movie($similar['id'],$similar['title']);?>" class="btn btn-danger absolute bottom form-control left"  > See Detail </a>
                     </div>
                  </div>
               </div>
            </div>
...
<!-- Trailer -->
<div id="trailer" class="modal fade" role="dialog"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal">&times;</button><h4 class="modal-title" style="color:black;font-style: normal;">Watch Trailer <?php echo $title;?></h4></div><div class="modal-body"><div class="embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" src="//www.youtube.com/embed/<?php echo $row['trailers']['youtube'][0]['source'];?>?rel=0&amp;modestbranding=1&amp;autoplay=0&amp;autohide=1&amp;showsuccess=1&amp;controls=0" onload="this.scrolling='no';this.allowfullscreen='true';" style="overflow:hidden;border:0;" scrolling="no"></iframe></div></div></div></div></div>
