...
<a title="<?php echo config('sitelogo'); ?>" href="<?php echo site_url() ?>" id="logo"><?php echo config('sitelogo'); ?></a>
</div>
...
<input maxlength="100" autocomplete="on" name="s" type="text" class="form-control search-input" placeholder="Searching...">
