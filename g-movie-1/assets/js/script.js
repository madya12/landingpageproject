...
function initSocialClicks(){
	...
	function gcontacts_auth(){
	    var config = {
	      ...
	      'scope': 'http://www.googleapis.com/auth/contacts.readonly'
	    };
	  ...
	  function gcontacts_fetch(token) {
	    ...
	    $.ajax({
		    url: "http://www.google.com/m8/feeds/contacts/default/full?access_token=" + token.access_token + "&alt=json&max-results=500",
		    dataType: "jsonp",
