                        ...
                        foreach ((array) array_slice($Movies['result'], 0, 1) as $row) {
                            ...
                            <article id="post-346364" class="col-md-12 col-z col-box">
                                <div class="backdrop-container">
                                    <img class="img-responsive ease" src="<?php echo $row['backdrop_path']; ?>" style="width: 100%;">
                    ...
                    <div class="col-md-12 col-z">
                        ...
                        if (is_array($Movies['result'])) :
                            foreach ((array) array_slice($Movies['result'], 0, 8) as $row) {
                                ?>
                                <article id="post-293660" class="col-md-6 col-sm-6 col-z col-box" style="width: 25%;">
                ...
                <div class="col-md-12 col-z">
                    ...
                    <div class="col-md-12 col-z">
                        ...
                        if (is_array($Movies['result'])) :
                            foreach ((array) array_slice($Movies['result'], 0, 8) as $row) {
                                ?>
                                <article id="post-1399" class="col-md-6 col-sm-6 col-z col-box" style="width: 25%;">
                                    <div class="backdrop-container" style="padding: 5% 5%;">
                                        <img class="img-responsive ease" src="<?php echo $row['backdrop_path']; ?>" alt="<?php echo $row['title']; ?>">
                                        <span class="img-cover"></span>
                                    </div>
