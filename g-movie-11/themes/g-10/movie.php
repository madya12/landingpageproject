...
<nav id="navbar" class="navbar is-fixed-top is-dark has-shadow" role="navigation" aria-label="main navigation" >
  <div class="container">
	...
	<title>Nonton <?php echo $title;?> (<?php echo date('Y', strtotime( $row['release_date'] ) );?>) Film Online | <?php echo config('sitename') ?></title>
	...
	<meta property="og:site_name" content="<?php echo config('sitename') ?>">
	<meta property="og:url" content="<?php echo site_uri() ?>">
	<meta property="og:title" content="Nonton <?php echo $title;?> (<?php echo date('Y', strtotime( $row['release_date'] ) );?>) Film Online | <?php echo config('sitename') ?>"> 
	...
	<div class="hero-body">
		<div class="container">
			...
			<div class="level">
				<div class="level-item has-text-centered ">		
					<div class="buttons">
					  <a class="button is-info modal-button" data-target="modal-cont"><p class="icon is-medium"> <i class="fa fa-play"></i></p>Watch Now</a>
					  <a class="button is-danger modal-button" data-target="modal-cont"><span class="icon is-medium"> <i class="fa fa-download"></i></span> Download</a>
					</div>
				</div>
			</div>
...
<main class="hero is-light is-fullheight parallax">
	<div class="hero-body">
			...
			<div class="tile is-ancestor">
				<div class="tile is-parent is-3">
					<article class="tile is-child box">
						<figure class="image is-1by2">
								<img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" data-src="<?php echo $images_small;?>" alt="<?php echo $title;?>">
						</figure>
				...
				<div class="tile is-parent ">
						...
						<article class="tile is-child box">
							...
							<h1 class="title"><?php echo $title;?> (<?php echo date('Y', strtotime( $row['release_date'] ) );?>)</h1>
							...
							<div class="buttons has-addons is-pulled-right is-paddingless is-hidden-mobile">
								Share on : 
								<a class="button is-facebook" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo site_uri() ?>&t=<?php echo $title;?> (<?php echo date('Y', strtotime( $row['release_date'] ) );?>)" target="_blank"><i class="fa fa-facebook"></i></a>
								
								<a class="button is-twitter" href="https://twitter.com/intent/tweet?source=<?php echo site_uri() ?>&amp;text=<?php echo $title;?> (<?php echo date('Y', strtotime( $row['release_date'] ) );?>):%20<?php echo site_uri() ?>" target="_blank"><i class="fa fa-twitter"></i></a>
								
								<a class="button is-gplus" href="https://plus.google.com/share?url=<?php echo site_uri() ?>" target="_blank"><i class="fa fa-google-plus"></i></a>
							</div>
						</article>
	...
	<div class="hero-body">
		...
		<hr>
			...
			<?php
					...
					<figure class="image is-1by2 ">
					<span class="movie-quality"><i class="fa fa-star"></i> 	<?php echo $similar['vote_average'];?></span>
						<img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" data-src="<?php echo $backdrop_path;?>" alt="<?php echo $similar['title'];?>">
...
<footer class="navbar is-dark has-shadow">
  <div class="container">
    ...
    <div class="navbar-menu "id="navFoot">
		<div class="navbar-start">
			<p class="navbar-item">Copyright &copy; <?php echo date('Y') ?> <a href="<?php echo site_url() ?>"> <?php echo config('sitename') ?></a>. All Rights Reserved.</p>
		</div>
