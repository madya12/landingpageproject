    ...
    <main class="hero">
        <div class="hero-body">
            <div class="container">
                <h2 class="subtitle is-uppercase has-text-weight-semibold">
                    NOW PLAYING MOVIES
                    <small><a href="<?php echo view_page('movies-nowplay'); ?>">See More..</a></small>
                </h2>
                <hr>
                            ...
                            <div class="column is-6-mobile is-3-tablet is-one-fifth-desktop ">
                                ...
                                <a href="<?php echo seo_movie($row['id'], $row['title']); ?>" class="box">
                                    ...
                                    <span class="movie-quality"><i
                                                class="fa fa-star"></i> 	<?php echo $row['vote_average']; ?></span>
                                        <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                             data-src="<?php echo $row['poster_path']; ?>"
        ...
        <div class="hero-body">
            <div class="container">
                <h2 class="subtitle is-uppercase has-text-weight-semibold">
                    TOP RATED MOVIES
                    <small><a href="<?php echo view_page('toprated-movies'); ?>">See More..</a></small>
                </h2>
                <hr>
                <div class="columns is-mobile is-multiline ">
                    ...
                    $Movies = unserialize(ocim_data_movie('home_toprated_movie_ ', $page, 'getTopRatedMovies'));
                    if (is_array($Movies['result'])):
                        foreach ((array)array_slice($Movies['result'], 0, 10) as $row) {
                            ?>
                            <div class="column is-6-mobile is-3-tablet is-one-fifth-desktop ">
