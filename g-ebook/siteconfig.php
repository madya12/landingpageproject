...
$site_url = 'https://g21.g-silvers.website';
$site_offer = 'https://www.facebook.com/galih.sophian.50';
$site_offer2 = 'https://www.facebook.com/';
/* Website title */
$site_title = 'New York Book Cafe';
/* iTunes Store 2-Letter Country Code (https://bookstore.armorthemes.com/countries) */
$site_country = 'us';
/* iTunes affiliate ID (optional) */
$itunes_id = '';
/* Amazon affiliate ID (optional) */
$amazon_id = 'dodonewsco-20';
/* AddThis ID for sharing analytics (optional) */
$addthis_id = '';
/* Disqus shortname for comments (optional) */
$disqus_shortname = 'newyorkbookcafe';
/* Contact form mail receiver (Optional) */
$contact_email = 'admin@nybookcafe.com';
/* ------ SEO SETTINGS ------ */
/* Homepage title */
$homepage_title = 'Online library of Best Seller Books, eBooks and Audiobooks ready to download';
/* Homepage meta description */
$homepage_desc = 'Featuring millions of books in all genres, including best sellers, new releases and many exclusive titles. Fiction, non-fiction, Art, Biographies, Business, Religion, Cookbooks, Computers, Health ebooks available to download.';
/* Website meta keywords */
$site_keywords = 'best seller books, online library, pdf books, audiobooks, Download Free EBooks, amazon books, itunes books, isbn database';
/* Book page title (Comes between book title and site title) */
$bookpage_title = '[PDF download]';
/* Audiobook page title (Comes between audiobook title and site title) */
$audiobpage_title = '[Audiobook download]';
...
$featbook_id1 = '909995954';
$featbook_id2 = '1200286159';
$featbook_id3 = '1149615754';
$featbook_id4 = '1071409887';
$featbook_id5 = '1212181256';
$featbook_id6 = '422546879';
$featbook_id7 = '1151017060';
$featbook_id8 = '1171074986';
/* ------ TRANSLATION OPTIONS ------ */
/* Homepage */
