...
<a href="<?php echo $geo_link; ?>&at=<?php echo $itunes_id;?>" style="margin-right: 10px;" class="btn btn-raised btn-warning"><?php echo $response->results[0]->formattedPrice;?> <?php echo $itunelink_mpage;?></a>
<?php endif; ?>
<?php if(isset($amazon_id) and !empty($amazon_id)): ?>
<a href="/req" class="btn btn-raised btn-danger">Read Now</a>
<?php endif; ?>
