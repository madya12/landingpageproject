...
<head>
    ...
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="<?php echo config('sitename') ?>">
    <link rel="stylesheet" id="bootstrap-css" href="//maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css"
        type="text/css" media="all">
    <link rel="stylesheet" id="jasny-css"
        href="//cdnjs.cloudflare.com/ajax/libs/jasny-bootstrap/3.1.3/css/jasny-bootstrap.min.css" type="text/css"
        media="all">
    <link rel="stylesheet" id="awesome-css" href="//maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css"
        type="text/css" media="all">
    <link rel="stylesheet" id="simple-css"
        href="//cdnjs.cloudflare.com/ajax/libs/simple-line-icons/2.4.1/css/simple-line-icons.min.css" type="text/css"
        media="all">
    <link rel="stylesheet" id="google-font" href="//fonts.googleapis.com/css?family=Oswald|Open+Sans" type="text/css"
        media="all">
            ...
            d = c.target, "string" == typeof c.target && (d = document.getElementById(c.target)), a = a
                .toLowerCase(), e = function(d) {
                    ...
                    for (var s = 0; k = f[s], s < f.length; s++) "ctrl" == k || "control" == k ? (g++, m = !0) :
                        ...
                        0) : 1 < k.length ? i[k] == code && g++ : c.keycode ? c.keycode == code && g++ : e ==
...
<body class=" movie single">
    <header>
        <div class="navbar navbar-default">
            <div class="container">
                <button type="button" class="side-toggle" data-toggle="offcanvas" data-target="#side-menu"
                    data-canvas="body">
