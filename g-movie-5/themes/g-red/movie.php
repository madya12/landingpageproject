                  ...
                  <div id="video-player" class="embed-responsive embed-responsive-16by9 video pointer nocontext">
                     ...
                     <span class="play-wrapper ease" style="visibility: visible;">
                        ...
                        <div class="media-title ease">
                           <h2 class="ell"><?php echo $title;?> <?php echo $year;?></h2>
                        </div>
                        ...
                        <div class="row">
                           <div class="col-md-3 text-center">
                              ...
                              <div class="rating-star" title="<?php echo $get_rating;?> out of 10 stars" itemprop="aggregateRating" itemscope itemtype="https://schema.org/AggregateRating">
                                 ...
                                 <div class="movie-rating"><span itemprop="ratingValue"><?php echo $get_rating;?></span>/<span itemprop="bestRating">10</span> by <span itemprop="ratingCount"><?php echo $vote_count;?></span> users</div>
                              </div>
                           </div>
                           <div class="col-md-9">
