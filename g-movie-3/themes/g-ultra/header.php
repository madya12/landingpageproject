...
<head itemscope itemtype="https://schema.org/WebSite">
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/modernizr/2.7.1/modernizr.min.js"
  ...
  ?>
    <style type="text/css">
        .body-home {
            background-image: url(<?php style_theme();
            ?>/images/<?php echo $selectedBg;
            ?>);
        ...
        .movie-loader {
            width: 100%;
            height: 100%;
            background: transparent url(images/preloader15.gif) center center no-repeat;
            display: block;
        }
        ...
        .ld7 .movie-loader {
            background-image: url(images/preloader7.gif);
        }

        .ld8 .movie-loader {
            background-image: url(images/preloader8.gif);
        }

        .ld9 .movie-loader {
            background-image: url(images/preloader9.gif);
        }

        .ld10 .movie-loader {
            background-image: url(images/preloader10.gif);
        }

        .ld11 .movie-loader {
            background-image: url(images/preloader11.gif);
        }

        .ld12 .movie-loader {
            background-image: url(images/preloader12.gif);
        }

        .ld13 .movie-loader {
            background-image: url(images/preloader13.gif);
        }

        .ld14 .movie-loader {
            background-image: url(images/preloader14.gif);
        }

        .ld15 .movie-loader {
            background-image: url(images/preloader15.gif);
        }

        .ld16 .movie-loader {
            background-image: url(images/preloader16.gif);
        }

        .ld17 .movie-loader {
            background-image: url(images/preloader17.gif);
        }
        ...
        .ctrlgrd .buffering {
            ...
            border-radius: 5px;
            box-shadow: inset 0 0 6px #000, 0 1px rgba(255, 255, 255, .1);
        }
        ...
        .ctrlgrd .progressbar {
            border-radius: 50%;
            box-shadow: inset 0 0 5px #000, 1px 0 #000;
        }
    ...
    <div class="wrapper">
        <div class="container">
            ...
            <div class="container menu-responsive">
                <div class="navbar navbar-light bg-light fixed-top" style="margin-top: 20px; background-color: #fff;">
                    <div style="padding-left: 5px;">
                        <div class="row">
                            <div class="col-lg-6 col-md-9 col-sm-6 col-xs-4">
                                        ...
                                        <div class="row">
                                            <div class="navbar-header">
                                                <button type="button" data-toggle="collapse"
                                                    ...
                                                    aria-expanded="false"> <i class="fa fa-bars"></i> Menu </button>
                                            </div>
                                            <div id="navbar-collapse-1" class="navbar-collapse collapse ddsmoothmenu">
                                                <ul class="nav navbar-nav">
                                                    ...
                                                    <li class="dropdown"> <a href="#" class="dropdown-toggle"
                                                            ...
                                                            aria-expanded="false"><i class="fa fa-video-camera"></i>
                                                            Movies <span class="caret"></span></a>
                                                        <ul class="dropdown-menu animated fadeIn" role="menu">
                                                            <li><a href="<?php echo view_page( 'movies-nowplay' );?>"><i
                                                                        class="fa fa-play-circle-o"></i> Now Playing</a>
                                                            </li>
                                                            <li><a href="<?php echo view_page( 'upcoming-movies' );?>"><i
                                                                        class="fa fa-random"></i> Upcoming</a></li>
                                                            <li><a href="<?php echo view_page( 'toprated-movies' );?>"><i
                                                                        class="fa fa-line-chart"></i> Top Rated</a></li>
                                                            <li><a href="<?php echo view_page( 'popular-movies' );?>"><i
                                                                        class="fa fa-trophy"></i> Popular</a></li>
                                                        </ul>
                                                    </li>
                                                    <li class="dropdown"> <a href="#" class="dropdown-toggle"
                                                            data-toggle="dropdown" role="button"
                                                            aria-expanded="false"><i class="fa fa-television"></i></i>
                                                            TV Series <span class="caret"></span></a>
                                                        <ul class="dropdown-menu  animated fadeIn" role="menu">
                                                            <li><a href="<?php echo view_page( 'tv-airing' );?>"><i
                                                                        class="fa fa-random"></i> Airing TV Shows</a>
                                                            </li>
                                                            <li><a href="<?php echo view_page( 'tv-ontheair' );?>"><i
                                                                        class="fa fa-line-chart"></i> On the Air TV
                                                                    Shows</a></li>
                                                            <li><a href="<?php echo view_page( 'tv-popular' );?>"><i
                                                                        class="fa fa-star"></i> Popular TV Series</a>
                                                            </li>
                                                        </ul>
                                                    </li>
                                                    <li class="dropdown"> <a href="#" class="dropdown-toggle"
                                                            ...
                                                            aria-expanded="false"><i
                                                                class="fa fa-folder-open-o"></i></i> Genres <span
                                                                class="caret"></span></a>
                                                        <ul class="dropdown-menu animated fadeIn" role="menu">
                                                            <?php if(isset($_cate)) foreach ($_cate as $cateid => $catename): ?>
                                                            <li><a
                                                                    href="<?php echo seocat( $catename,$cateid );?>"><?php echo ucwords($catename) ?></a>
                                                            </li>
                                                            <?php endforeach ?>
                                                        </ul>
                                                    </li>
                            ...
                            <div class="searchbox">
                                    <form action="/" method="get">
                                        <input type="text" name="s" placeholder="Search Here...">
                                        <input type="submit" class="pull-right" value="GO">
                                    </form>
                                </div>
                            </div>
                            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-8">
                                ...
                                <div class="loginsec pull-right" style="a{color: black;}">
                                    <a href="/?action=register&s2=59e4cf925fc61a59174d81ea&s3=59c4aa325fc61a765ec8715d"><i
