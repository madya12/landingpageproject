                                 ...
                                 <table class="d-none d-sm-block table table-no-bordered mb-3" style="color: #fff;">
                                    <tbody>
                                       <!--												<tr><th class="pl-0">Genre</th><td>:</td><td> <?php echo $genre;?> </td></tr>
                                          <tr><th class="pl-0">Last Air Date</th><td>:</td><td> <?php echo $last_air_date;?></td></tr>
                                          <tr><th class="pl-0">Companies</th><td>:</td><td> <td> <?php echo $networks;?></td></td></tr>
                                       ...
                                       <tr>
                                          <th class="pl-0">Last Air Date</th>
                                          <td>:</td>
                                          <td> <?php echo $last_air_date;?></td>
                                       </tr>
                                       <tr>
                           ...
                           <div class="container">
                              ...
                              foreach((array)$row['seasons'] as $for) :
                                  ...
                                  if ($for[poster_path]) {
                                      ...
                                      $poster_path = site_theme().'/img/no-cover.png';
                                  }
                                  ?>
                                    <div class="video-item2">
                                       <div class="thumb-wrap2 text-center" style="width: 100%;">
                                          <img src="<?php echo $poster_path;?>" alt="Season <?php echo $for['season_number'];?>">
                                       ...
                                       <div class="video-details">
                                          ...
                                          <p class="video-release-on"><?php echo $for['episode_count'];?> Episode(s)</p>
                                       </div>
                                    </div>
<?php 
                              endforeach;
         ...
         <div class="col-12">
			...
			<?php 
                                             if (is_array($row2['episodes'])) {
                                                 ?>
               <h3 class="section-title">Episode List of Season <?php echo $row['season_number'];?></h3>
            </div>
         </div>
      </div>
      <div class="row">
...
<?php
                                          foreach((array)$row2['episodes'] as $eps) :
                                              if ($eps[still_path]) {
                                                  ...
                                                  $still_path = site_theme().'/img/no-backdrop.png';
                                              }
                                              ?>
            <div class="video-item2">
               <div class="thumb-wrap3">
                  <img src="<?php echo $still_path;?>" alt="Episode <?php echo $eps['episode_number'];?>" style="width: 100%">
                  <div class="thumb-hover">
                     <a class="play-video" href="<?php echo seo_tv($id.'-'.$eps['season_number'].'-'.$eps['episode_number'],$row['name']);?>"><i class="fa fa-play"></i></a>
                  </div>
               </div>
               <div class="video-details2">
                  <h4 class="video-title"><a href="<?php echo seo_tv($id.'-'.$eps['season_number'].'-'.$eps['episode_number'],$row['name']);?>">Episode <?php echo $eps['episode_number'];?></a></h4>
                  <p class="video-release-on"><?php echo short($row['overview']);?> <?php echo date('Y-m-d', strtotime( $eps['air_date'] ) );?></p>
               </div>
            </div>
			<?php 
                                          endforeach;
