...
?>
    ...
    <div class="section section-padding bg-image upcomming-section">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="section-header">
                        <h2 class="section-title">Upcomming Movie</h2>
                        <small><a class="all-link" href="<?php echo view_page('upcomming-movies'); ?>">See All Movies</a></small>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 col-xs-12 sm-top-30 text-white">
                    <?php
                    if (empty($_GET['page'])) {
                        $page = 1;
                    } else {
                    ...
                    if (is_array($Movies['result'])):
                        foreach ((array)array_slice($Movies['result'], 0, 12) as $row) {
                            ...
                            <div class="upcomming-item">
                                <img class="img-responsive" src="<?php echo $row['backdrop_path']; ?>" width="260"
                                     height="198" alt="upcomming">
                                ...
                                <div class="upcomming-hover">
                                    <a class="play-video" href="<?php echo seo_movie($row['id'], $row['title']); ?>"><i
                ...
                <div class="row">
                    <div class="col-sm-8 col-xs-6">
                        <div class="section-header">
                            ...
                            <small><a class="all-link" href="<?php echo view_page('popular-movies'); ?>">See All Movies</a></small>
                        </div>
                    </div>
                </div>

                <div class="row">
                    <div class="owl-carousel video-carousel owl-theme" id="video-carousel"
                         style="opacity: 1; display: block;">
                        <div class="owl-wrapper-outer">
                            <div class="owl-wrapper" style="width: 4688px; left: 0px; display: block;">
                ...
                <div class="row">
                    <div class="col-sm-8 col-xs-6">
                        <div class="section-header">
                            ...
                            <small><a class="all-link" href="<?php echo view_page('tv-ontheair'); ?>">See All Tv Show</a></small>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="owl-item" style="width: 293px;">
                                            <div class="video-item">
                                                <div class="thumb-wrap">
                                                    ...
                                                    <div class="thumb-hover">
                                                        <a class="play-video"
                                                           href="<?php echo seo_tv($row['id'], $row['title']); ?>"><i
                                                                    class="fa fa-play"></i></a>
                                                    </div>
                                                </div>
                                                <div class="video-details">
                                                    <h4 class="video-title"><a
                                                                href="<?php echo seo_tv($row['id'], $row['title']); ?>"><?php echo $row['title']; ?></a>
                                                    </h4>
                                                    <p class="video-release-on"><?php echo date('Y-m-d', strtotime($row['release_date'])); ?></p>
                                                </div>
                                            </div>
