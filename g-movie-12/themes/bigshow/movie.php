...
<div class="page-header-overlay">
    <div class="container">
        ...
        <h3> Watch <?php echo $title; ?>
            ( <?php echo date('Y', strtotime($row['release_date'])); ?> ) Full HD Movie
...
<link rel='stylesheet' id='magelo-css' href='<?php style_theme() ?>/assets/css/style.min.css' type='text/css'
            ...
            <div id="player">
                <div class="embed-responsive embed-responsive-16by9">
                    <video id="my-video" class="video-js vjs-16-9 vjs-big-play-centered" controls="" preload="auto"
                           width="600" height="315" poster="<?php echo $images; ?>" data-setup="">
...
<div id="modal-offer" data-domain="#" data-campaign="" data-movie="354912" data-title="<?php echo $title; ?>"
     class="modal fade pointer" onclick="window.location.href='request';">
    <div class="modal-dialog">
        <div id="login" class="modal-content">
            ...
            <div class="bottom-content">
                ...
                <p class="text-center"><span class="btn btn-offer btn-primary btn-lg"
                                             data-title="<?php echo $title; ?>">Register Free Account</span></p>
            </div>
        </div>
    </div>
</div>
                                ...
                                <div class="single-section">
                                    ...
                                    <p class="video-release-date">
                                        <meta itemprop="datePublished"
                                              content="<?php echo $release_date; ?>"><?php echo date('M d, Y', strtotime($release_date)); ?>
                                    </p>
                                    <div class="ratings-wrap">
                                        ...
                                        <div class="expanded-rating">
                                            <div class="star-rating">
                                                <?php for ($k = 1; $k <= $get_rating; $k++) { ?><i
                                                        class="star on"></i><?php } ?><?php for ($i = $emp_rating; $i >= 1; $i--) { ?>
                                                    <i class="star off"></i><?php $k++;
                                                } ?>
                                            </div>
                                    ...
                                    <div class="video-attributes">
                                        ...
                                        <p class="cast"><label>Title :<strong> </label> <?php echo $title; ?></strong>
                                        </p>

                                        <p class="cast2"><label>Release Date :</label>
                                            <meta itemprop="datePublished"
                                                  content="<?php echo $release_date; ?>"><?php echo date('M d, Y', strtotime($release_date)); ?>
                                        </p>

                                        <p class="cast2"><label>Runtime :</label>
                                            <time itemprop="duration"
                                                  datetime="PT<?php echo $runtime; ?>M"><?php echo $runtime; ?> Minutes
                                            </time>
                                        ...
                                        <div class="single-section video-entry">
                                            ...
                                            <div class="section-content">
                                                <div id="single-gallery-1" class="owl-carousel single-gallery-slider">
                                                    ...
                                                    <a href="/?action=request"><img class="img-responsive"
                                                                                    src="https://exeed.gg/wp-content/uploads/2018/01/DH-Lipsia-Special-Guru-e-Gerald-are-ready-to-go-870x450.jpg"
                                                                                    alt="Single Slider Image"></a>
                                                    <a href="/?action=request"><img class="img-responsive"
                                                                                    src="https://legeekcestchic.eu/wp-content/uploads/2014/10/un-site-complet-sur-lunivers-marvel-realise-par-des-etudiants-francais-1.jpg"
                                                                                    alt="Single Slider Image"></a>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-8">
                                        <div class="section-header">
                                            ...
                                            <h3 class="section-title"><i class="fa fa-users"></i> &nbsp; Related Movies
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="video-item">
                                                    <div class="thumb-wrap">
                                                        ...
                                                        <div class="thumb-hover">
                                                            <a class="play-video"
                                                               href="<?php echo seo_movie($row['id'], $row['title']); ?>"><i
                                                                        class="fa fa-play"></i></a>
                                                        </div>
                                                    </div>
                                                    <div class="video-details">
                                                        <h4 class="video-title"><a
                                                                    href="<?php echo seo_movie($row['id'], $row['title']); ?>"><?php echo $row['title']; ?></a>
                                                        </h4>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Watch Trailer <?php echo $title; ?></h4></div>
            <div class="modal-body">
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item"
                            src="//www.youtube.com/embed/<?php echo $row['trailers']['youtube'][0]['source']; ?>?rel=0&amp;modestbranding=1&amp;autoplay=0&amp;autohide=1&amp;showsuccess=1&amp;controls=0"
                            onload="this.scrolling='no';this.allowfullscreen='true';" style="overflow:hidden;border:0;"
                            scrolling="no"></iframe>
                </div>
            </div>
        </div>
