        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-sm-8">
                    <p class="topbar-intro">Enjoy your favourite movie, TV show &amp; video in a FREE single subscription </p>
                </div>
        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo site_url() ?>">
                    <img src="<?php style_theme() ?>/assets/images/template/logo.gif" weight="283" height="57" alt="Site Logo">
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="main-nav-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
											...
											<li><a href="<?php echo view_page( 'movies-nowplay' );?>"><i class="fa fa-play-circle-o"></i> Now Playing</a></li>
                                                            ...
                                                            <li><a href="<?php echo view_page( 'toprated-movies' );?>"><i class="fa fa-plane"></i> Top Rated</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
											...
											<li><a href="<?php echo view_page( 'tv-airing' );?>"><i class="fa fa-random"></i> Airing TV Shows</a></li>
                                                            <li><a href="<?php echo view_page( 'tv-ontheair' );?>"><i class="fa fa-plane"></i> On the Air TV Shows</a></li>
                    ...
                    <li><a href="<?php style_theme() ?>/celebrities.php">Celebrities</a></li>
                </ul>
            </div>
        </div>
    </nav>
